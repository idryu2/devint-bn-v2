...
/*		if (i == 0) {
		...
		voix.playText("Entre un chiffre de 2 à 9 pour choisir la taille de la grille.");
			String[] choix = { "2", "3", "4", "5", "6", "7", "8", "9" };

			str2 = (String) new JOptionPane().showInputDialog(null,
					"Quelle taille de grille désires-tu ?",
					"Choix de la taille", JOptionPane.QUESTION_MESSAGE, null,
					choix, choix[2]);
			if (str2 != null)
				new Interface(Integer.parseInt(str2), false, new Joueur(""));
